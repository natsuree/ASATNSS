    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <div class="asat-password-wrap mt-1">
                ...
                <x-password-toggle-button target="update_password_current_password" />
            </div>
        ...
        <div>
            ...
            <div class="asat-password-wrap mt-1">
                <x-text-input id="update_password_password" name="password" type="password" class="block w-full" autocomplete="new-password" data-password-strength />
                <x-password-toggle-button target="update_password_password" />
            </div>
        ...
        <div>
            ...
            <div class="asat-password-wrap mt-1">
                ...
                <x-password-toggle-button target="update_password_password_confirmation" />
            </div>
